@echo off
REM =====================================================
REM Script de instalação automática do OpenCV + contrib
REM =====================================================
...
setx OPENCV_DIR "%OPENCV_INSTALL%\x64\vc16\lib\cmake\opencv4" /M
setx PATH "%PATH%;%OPENCV_INSTALL%\x64\vc16\bin" /M
